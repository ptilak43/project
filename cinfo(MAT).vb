...
Public Class CNR
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If (TextBox2.Text = "") Then
            Label11.Text = "enter gst number"
            Exit Sub
        Else
            If (TextBox2.Text.Length = 15) Then

            Else
                Label11.Text = "gst number should be 15 alphanumeric characters long"
                Exit Sub
            End If
        End If

        If (TextBox3.Text = "") Then
            Label11.Text = "enter company name"
            Exit Sub
        End If
        ...
        If (TextBox6.Text = "") Then
            Label11.Text = "enter office address"
            Exit Sub
        End If
        ...
        Do While (i <= 0)
            ...
            str = "select * from company_info where cpy_id='" & digit1 & "'"
            ...
            If check = 0 Then
                i = i + 1
                str = "insert into company_info values('" + digit1 + "','" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + DateTimePicker1.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + TextBox7.Text + "','" + TextBox8.Text + "')"
                cmd = New SqlCommand(str, cn)
                cn.Open()
                cmd.ExecuteNonQuery()
                cn.Close()
